...
function cryout_register_addon_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'roseta',                // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'roseta-addons',		   // Menu slug.
		...
		'strings'      => array(
			'page_title'                      => __( 'Roseta Suggested Plugins', 'cryout' ),
			'menu_title'                      => __( 'Roseta Addons', 'cryout' ),
